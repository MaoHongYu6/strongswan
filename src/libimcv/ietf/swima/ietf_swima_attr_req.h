...
struct ietf_swima_attr_req_t {
	 ...
	 * Add SW ID target
	 *
	 * @param sw_id			SW ID (is not cloned by constructor!)
	 */
	void (*add_target)(ietf_swima_attr_req_t *this, swima_sw_id_t *sw_id);

	/**
	 * Create SW ID target enumerator
	 *
	 * @return				Get a list of SW ID targets
	 */
	enumerator_t* (*create_target_enumerator)(ietf_swima_attr_req_t *this);
